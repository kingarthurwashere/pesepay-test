...
var Pesepay = (function () {
    function Pesepay(integrationKey, encryptionKey) {
        ...
        this.initiateTransaction = function (transaction) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, axios_1.default.post(constants_1.INITIATE_PAYMENT_URL, { payload: payload }, { headers: this.headers })];
                    case 2:
                        response = _a.sent();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        message = error_1.response.data.message || 'Something went wrong!';
        ...
        this.checkPayment = function (referenceNumber) { return __awaiter(_this, void 0, void 0, function () {
            var url;
            return __generator(this, function (_a) {
                url = constants_1.CHECK_PAYMENT_URL + "?referenceNumber=" + referenceNumber;
        ...
        this.pollTransaction = function (pollUrl) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, axios_1.default.get(pollUrl, { headers: this.headers })];
                    case 1:
                        response = _a.sent();
                    ...
                    case 2:
                        error_2 = _a.sent();
                        message = error_2.response.data.message || 'Something went wrong!';
                        return [2, new response_1.PesepayResponse(false, message)];
                    case 3: return [2];
                }
            });
        ...
        this.makeSeamlessPayment = function (payment, reasonForPayment, amount, requiredFields) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, axios_1.default.post(constants_1.MAKE_SEAMLESS_PAYMENT_URL, { payload: payload }, { headers: this.headers })];
                    case 2:
                        response = _a.sent();
                        resObj = JSON.parse(this.payloadDecrypt(response.data.payload));
                        paid = resObj.transactionStatus == 'SUCCESS';
                    ...
                    case 3:
                        error_3 = _a.sent();
                        message = error_3.response.data.message || 'Something went wrong!';
                        return [2, new response_1.PesepayResponse(false, message)];
                    case 4: return [2];
                }
            });
    ...
    Pesepay.prototype.buildCipher = function (key, mode) {
        ...
        if (mode === "encrypt")
            return crypto_1.default.createCipheriv(constants_1.ALGORITHM, keyBuffer, iv);
        else
            return crypto_1.default.createDecipheriv(constants_1.ALGORITHM, keyBuffer, iv);
    };
    return Pesepay;
}());
